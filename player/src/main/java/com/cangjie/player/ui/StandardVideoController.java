...
import com.cangjie.player.core.controller.GestureVideoController;
import com.cangjie.player.core.player.VideoView;
import com.cangjie.player.util.PlayerUtils;

/**
 * @author guruohan
 * @time 1/15/21 10:10 AM
 * 直播/点播控制器
...
public class StandardVideoController extends GestureVideoController implements View.OnClickListener {
     ...
     * @param isLive 是否为直播
     */
    public void addDefaultControlComponent(String title, boolean isLive, boolean isFullScreen) {
        ...
        if (isLive) {
            addControlComponent(new LiveControlView(getContext(), isFullScreen));
        } else {
