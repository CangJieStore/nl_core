 ...
 * @param ivTorch
 */(private val activity: Activity?, private val surfaceView: SurfaceView, private val viewfinderView: ViewfinderView?, private val ivTorch: View?) : CaptureLifecycle,
    CaptureTouchEvent, CaptureManager, SurfaceHolder.Callback {
     ...
     */
    private var tooDarkLux = AmbientLightManager.TOO_DARK_LUX

    /**
     * 光线足够明亮，当光线亮度足够明亮，亮度高于此值时，隐藏手电筒按钮
     */
    private var brightEnoughLux = AmbientLightManager.BRIGHT_ENOUGH_LUX
     ...
     */
    @Deprecated("")
    constructor(fragment: Fragment, surfaceView: SurfaceView, viewfinderView: ViewfinderView?) : this(fragment, surfaceView, viewfinderView, null) {
    }

    constructor(fragment: Fragment, surfaceView: SurfaceView, viewfinderView: ViewfinderView?, ivTorch: View?) : this(fragment.activity, surfaceView, viewfinderView, ivTorch) {}
     ...
     */
    @Deprecated("")
    constructor(activity: Activity?, surfaceView: SurfaceView, viewfinderView: ViewfinderView?) : this(activity, surfaceView, viewfinderView, null) {
    }
    ...
    override fun onCreate() {
        ...
        initCameraManager()
        onCaptureListener = object : OnCaptureListener {
    ...
    private fun initCamera(surfaceHolder: SurfaceHolder?) {
        ...
        try {
            ...
            if (captureHandler == null) {
                captureHandler = CaptureHandler(activity, viewfinderView, onCaptureListener!!, decodeFormats, decodeHints, characterSet, cameraManager!!)
     ...
     * @return
     */
    fun decodeFormats(decodeFormats: Collection<BarcodeFormat>?): CaptureHelper {
    ...
    fun decodeHint(key: DecodeHintType, value: Any): CaptureHelper {
        if (decodeHints == null) {
            decodeHints = EnumMap(DecodeHintType::class.java)
        }
